function    [Aeff, Ic,Power_upper_clad,Power_waveguide,Power_lower_clad] = wg_area_eff(Hxc,Hyc,Hzc,Exc,Eyc,Ezc,n,dx,dy,eps);
...
Power_upper_clad   = sum(Ic(In3).*Ids(In3))/Power_all;
