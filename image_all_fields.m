function [neff_TE,neff_TM]=image_all_fields(nmode, lambda, neff, Hx, Hy, dx, dy, eps,n,xc,yc,x,y)
...
if hn1>hn2
    ...
    neff_TE(TE_n)=neff(ii);
    
%     fprintf('mode %c%c,neff= %7.5f \n',mode,neff_TE);
